...
<template>
	...
	>
		<div class="flex items-center text-gray-900">
			<NuxtLink
				to="/"
				class="mr-4 block cursor-pointer py-1.5 font-sans leading-relaxed text-inherit antialiased font-bold text-lg !text-black"
			>
				Nuxt-Type
			</NuxtLink>
		...
		<div
			class="block h-0 w-full basis-full overflow-hidden text-blue-gray-900 transition-all duration-200 ease-in lg:hidden"
			:class="{ 'h-[160px]': openNav }"
			data-collapse="sticky-navar"
		>
			<ul class="mt-2 mb-4 flex text-black flex-col gap-2 pb-2">
				<li
					class="block p-1 font-sans text-sm font-normal leading-normal text-inherit antialiased"
				>
					<NuxtLink to="/"> Home </NuxtLink>
