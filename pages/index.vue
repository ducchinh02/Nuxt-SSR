...
<template>
	<div>
		...
		<div
			...
			style="height: 50vh; max-height: 360px; aspect-ratio: 2/1"
		>
			<img
			...
			<div class="mx-0 sm:mx-6">
				...
				>
					...
					<div class="flex flex-wrap justify-between pt-12 -mx-6">
						<!--1/3 col -->
						<div
							class="w-full md:w-1/3 p-3 flex flex-col flex-grow flex-shrink"
						>
							<div
								class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg"
							>
						...
						<!--1/2 col -->
						<div
							class="w-full md:w-1/2 p-3 flex flex-col flex-grow flex-shrink"
						>
							<div
								class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg"
							>
						...
						<!--2/3 col -->
						<div
							class="w-full md:w-2/3 p-3 flex flex-col flex-grow flex-shrink"
						>
							<div
								class="flex-1 bg-white rounded-t rounded-b-none overflow-hidden shadow-lg"
							>
